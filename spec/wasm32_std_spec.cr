# This file is autogenerated by `spec/generate_wasm_spec.sh`
# 2020-09-27 23:55:34-05:00

require "./std/array_spec.cr"
require "./std/atomic_spec.cr"
# require "./std/base64_spec.cr" (failed codegen)
...
# require "./std/colorize_spec.cr" (failed codegen)
require "./std/comparable_spec.cr"
require "./std/complex_spec.cr"
# require "./std/compress/deflate/deflate_spec.cr" (failed codegen)
# require "./std/compress/gzip/gzip_spec.cr" (failed codegen)
# require "./std/compress/zip/zip_file_spec.cr" (failed codegen)
# require "./std/compress/zip/zip_spec.cr" (failed codegen)
# require "./std/compress/zlib/reader_spec.cr" (failed codegen)
# require "./std/compress/zlib/stress_spec.cr" (failed codegen)
# require "./std/compress/zlib/writer_spec.cr" (failed codegen)
# require "./std/concurrent/select_spec.cr" (failed codegen)
# require "./std/concurrent_spec.cr" (failed codegen)
require "./std/crypto/bcrypt/base64_spec.cr"
# require "./std/crypto/bcrypt/password_spec.cr" (failed codegen)
# require "./std/crypto/bcrypt_spec.cr" (failed codegen)
...
# require "./std/csv/csv_build_spec.cr" (failed codegen)
# require "./std/csv/csv_lex_spec.cr" (failed codegen)
# require "./std/csv/csv_parse_spec.cr" (failed codegen)
# require "./std/csv/csv_spec.cr" (failed codegen)
...
# require "./std/enumerable_spec.cr" (failed codegen)
...
# require "./std/http/http_spec.cr" (failed codegen)
# require "./std/http/params_spec.cr" (failed codegen)
...
# require "./std/io/argf_spec.cr" (failed codegen)
# require "./std/io/buffered_spec.cr" (failed codegen)
# require "./std/io/byte_format_spec.cr" (failed codegen)
# require "./std/io/delimited_spec.cr" (failed codegen)
# require "./std/io/file_descriptor_spec.cr" (failed codegen)
# require "./std/io/hexdump_spec.cr" (failed codegen)
# require "./std/io/io_spec.cr" (failed codegen)
# require "./std/io/memory_spec.cr" (failed codegen)
# require "./std/io/multi_writer_spec.cr" (failed codegen)
# require "./std/io/sized_spec.cr" (failed codegen)
# require "./std/io/stapled_spec.cr" (failed codegen)
require "./std/iterator_spec.cr"
# require "./std/json/any_spec.cr" (failed codegen)
# require "./std/json/builder_spec.cr" (failed codegen)
# require "./std/json/lexer_spec.cr" (failed codegen)
# require "./std/json/parser_spec.cr" (failed codegen)
# require "./std/json/pull_parser_spec.cr" (failed codegen)
...
# require "./std/llvm/aarch64_spec.cr" (failed codegen)
# require "./std/llvm/arm_abi_spec.cr" (failed codegen)
# require "./std/llvm/llvm_spec.cr" (failed codegen)
# require "./std/llvm/type_spec.cr" (failed codegen)
# require "./std/llvm/x86_64_abi_spec.cr" (failed codegen)
# require "./std/llvm/x86_abi_spec.cr" (failed codegen)
# require "./std/log/broadcast_backend_spec.cr" (failed codegen)
# require "./std/log/builder_spec.cr" (failed codegen)
# require "./std/log/context_spec.cr" (failed codegen)
# require "./std/log/dispatch_spec.cr" (failed codegen)
# require "./std/log/env_config_spec.cr" (failed codegen)
# require "./std/log/format_spec.cr" (failed codegen)
# require "./std/log/io_backend_spec.cr" (failed codegen)
# require "./std/log/log_spec.cr" (failed codegen)
# require "./std/log/main_spec.cr" (failed codegen)
# require "./std/log/metadata_spec.cr" (failed codegen)
# require "./std/log/spec_spec.cr" (failed codegen)
require "./std/match_data_spec.cr"
require "./std/math_spec.cr"
# require "./std/mime/media_type_spec.cr" (failed codegen)
...
# require "./std/mime_spec.cr" (failed codegen)
...
# require "./std/proc_spec.cr" (failed codegen)
...
# require "./std/spec/junit_formatter_spec.cr" (failed codegen)
...
# require "./std/string_pool_spec.cr" (failed codegen)
require "./std/string_scanner_spec.cr"
# require "./std/string_spec.cr" (failed codegen)
# require "./std/string/utf16_spec.cr" (failed codegen)
...
# require "./std/time/custom_formats_spec.cr" (failed codegen)
# require "./std/time/format_spec.cr" (failed codegen)
# require "./std/time/location_spec.cr" (failed codegen)
require "./std/time/span_spec.cr"
# require "./std/time/time_spec.cr" (failed codegen)
require "./std/tuple_spec.cr"
require "./std/uint_spec.cr"
require "./std/uri/punycode_spec.cr"
# require "./std/uri_spec.cr" (failed codegen)
require "./std/uuid_spec.cr"
# require "./std/va_list_spec.cr" (failed codegen)
# require "./std/weak_ref_spec.cr" (failed codegen)
# require "./std/xml/builder_spec.cr" (failed codegen)
# require "./std/xml/html_spec.cr" (failed codegen)
# require "./std/xml/reader_spec.cr" (failed codegen)
# require "./std/xml/xml_spec.cr" (failed codegen)
# require "./std/xml/xpath_spec.cr" (failed codegen)
# require "./std/yaml/any_spec.cr" (failed codegen)
