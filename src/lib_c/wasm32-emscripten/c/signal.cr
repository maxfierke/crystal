...
lib LibC
  ...
  fun sigaddset(x0 : SigsetT*, x1 : Int) : Int
  fun sigdelset(x0 : SigsetT*, x1 : Int) : Int
  fun sigemptyset(x0 : SigsetT*) : Int
  fun sigfillset(x0 : SigsetT*) : Int
  fun sigismember(x0 : SigsetT*, x1 : Int) : Int
